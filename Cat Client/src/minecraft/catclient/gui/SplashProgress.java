...
public class SplashProgress {
	...
	public static void drawSplash(TextureManager tm) {
		...
		if (splash == null) {
			splash = new ResourceLocation("catclient/splash.png");
		}
	...
	private static void drawProgress() {
		...
		if (ufr == null) {
			ufr = UnicodeFontRenderer.getFontOnPC("Fira Code", 20);
		}
		...
		ufr.drawString(CURRENT, 20, sr.getScaledHeight() - 25, -1);
